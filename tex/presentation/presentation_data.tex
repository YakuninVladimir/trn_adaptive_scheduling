...
\providecommand{\PresArcQcYmin}{0.724750}
\providecommand{\PresArcQcYmax}{0.750250}
...
\addplot coordinates {(3.44,0.730000)};
\addlegendentry{Конечное дискретное}
\addplot coordinates {(5,0.737000)};
\addlegendentry{Сглаженная разметка}
\addplot coordinates {(4.25,0.745000)};
\addlegendentry{Смесь геометрических}
\addplot coordinates {(3.5,0.742000)};
\addlegendentry{Смесь экспоненциальных}
\addplot coordinates {(3.71,0.741000)};
\addlegendentry{Степенной спад}
\addplot coordinates {(3.85,0.731000)};
